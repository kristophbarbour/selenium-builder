...
m.record_generic = "Add Custom Step";
m.start_transaction = "Start Transaction";
m.stop_transaction = "Stop Transaction";
m.transaction_name = "Transaction Name";
m.get_perf = "Get Browser Perf";
m.eval_js = "Eval JS";
